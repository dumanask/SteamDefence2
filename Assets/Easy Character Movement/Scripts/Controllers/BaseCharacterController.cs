...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        protected virtual void HandleInput()
        {
            ...
            Vector2 movementInput = playerController.PlayerMovement.Move.ReadValue<Vector2>();

            moveDirection = new Vector3
            {
                x = movementInput.x, // Input.GetAxisRaw("Horizontal"),
                y = 0.0f,
                z = movementInput.y //Input.GetAxisRaw("Vertical")
            };
